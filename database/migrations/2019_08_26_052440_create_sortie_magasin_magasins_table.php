...
class CreateSortieMagasinMagasinsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sortie_magasin_magasins', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sortie_magasin_magasins');
    }
}
