            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
							...
							@endif
							<form method="post" action="{{ route('produits.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
							<div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('reference') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-reference">{{ __('reference') }}</label>
                                    <input type="text" name="reference" id="input-reference" class="form-control form-control-alternative{{ $errors->has('reference') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer la reference') }}" value="{{ old('reference') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('prix_achat') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" min="0" name="prix_achat" id="input-prix_achat" class="form-control form-control-alternative{{ $errors->has('prix_achat') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le prix d\'achat') }}" value="{{ old('prix_achat') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('prix') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" min="0" name="prix" id="input-prix" class="form-control form-control-alternative{{ $errors->has('prix') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le prix de vente') }}" value="{{ old('prix') }}" required autofocus>
