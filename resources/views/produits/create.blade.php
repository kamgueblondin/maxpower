                    ...
                    <div class="card-body">
							...
							<div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('prix') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" min="0" name="prix" id="input-prix" class="form-control form-control-alternative{{ $errors->has('prix') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le prix') }}" value="{{ old('prix') }}" required autofocus>
