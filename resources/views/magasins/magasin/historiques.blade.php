...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $magasin->nom }} {{ $magasin->localisation }} historiques.</title>
        <!-- Favicon -->
	    ...
	    <div class="container-fluid">
	        <div class="header-body">
	           <div class="row align-items-center py-4">
	            ...
	            <a href="{{ route('historiques.magasins.print',$magasin->id) }}" class="btn btn-sm btn-neutral mt-1 d-none d-sm-none d-md-none d-lg-none d-xl-inline-flex">Imprimer</a>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel">{{ $magasin->nom }} {{ $magasin->localisation }} historiques.</h5>
				      ...
				      <div class="modal-body text-center">
				        ...
				        <a href="{{ route('historiques.magasins.print',$magasin->id) }}" class="btn btn-sm btn-neutral mt-1">Imprimer</a>
	            		</li>
						</ul>
				      </div>
				    </div>
                ...
                <div class="card table-responsive shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Historique du magasin') }}</h3>
                            </div>
					...
					<table class="table  table-bordered  bg-white" style="width:100%;"  id="datatable-buttons">
					  ...
					  <tr>
		                ...
		                <tbody>
					    @php $i=0; @endphp
						@foreach ($magasin->historiques as $key => $historique)
						<tr>
							<td>{{ ++$i }}</td>
