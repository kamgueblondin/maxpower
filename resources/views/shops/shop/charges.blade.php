...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $boutique->nom }} {{ $boutique->localisation }} Les charges.</title>
        <!-- Favicon -->
	...
	<div class="header bg-primary bg-gradient-primary pb-7 pt-5 pt-md-8">
	    ...
	    <div class="col-lg-6 col-7">
	    	...
	    	<div class="col-lg-6 col-5 text-right">
	            ...
	            <a href="{{ route('charges.shops.print.jours',$boutique->id) }}" class="btn btn-sm btn-neutral mt-1 d-none d-sm-none d-md-none d-lg-none d-xl-inline-flex">Imprimer</a>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel">{{ $boutique->nom }} {{ $boutique->localisation }} Les charges</h5>
				      ...
				      <div class="modal-body text-center">
				        ...
				        <a href="{{ route('charges.shops.print.jours',$boutique->id) }}" class="btn btn-sm btn-neutral mt-1">Imprimer</a>
	            		</li>
	            		 </li>
						</ul>
				      </div>
                ...
                <div class="card table-responsive shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Les charges de ') }} {{$boutique->nom}} {{$boutique->localisation}}</h3>
                            </div>
