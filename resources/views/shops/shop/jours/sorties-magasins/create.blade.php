                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('jours.boutiques.magasins.sorties',$jour->id) }}" class="btn btn-sm btn-primary">{{ __('Retours à l\'accueil') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                      <div class="col-12">
                        ...
                        @endif
							...
							@endif
							<form method="post" id="form" action="{{ route('boutique-magasins-sorties.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                                 <div class="form-group{{ $errors->has('magasin') ? ' has-danger' : '' }}">
                                    ...
                                    <select type="text" name="magasin" id="input-magasin" class="form-control form-control-alternative{{ $errors->has('magasin') ? ' is-invalid' : '' }}" required autofocus>
                                        @foreach($boutique->magasins as $m)
