...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $boutique->nom }} {{ $boutique->localisation }} Liste des ventes en solde.</title>
        <!-- Favicon -->
			...
			<div class="main-content">
				...
				<div class="header bg-primary bg-gradient-primary pb-7 pt-5 pt-md-8">
			        ...
			        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
			            ...
			            <li class="breadcrumb-item active" aria-current="page">Soldes</li>
			            </ol>
			        </nav>
			    </div>
	        <div class="col-lg-6 col-5 text-right">
	        	@can('boutique-comptabilite')
	            <a href="{{ route('soldes.shops.print.jours',$boutique->id) }}" class="btn btn-sm btn-neutral mt-1 d-none d-sm-none d-md-none d-lg-none d-xl-inline-flex">Imprimer</a>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel">{{ $boutique->nom }} {{ $boutique->localisation }} Liste des ventes</h5>
				      ...
				      <div class="modal-body text-center">
				        ...
				        <a href="{{ route('soldes.shops.print.jours',$boutique->id) }}" class="btn btn-sm btn-neutral mt-1">Imprimer</a>
	            		</li>
						</ul>
				      </div>
				    </div>
                ...
                <div class="card table-responsive shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Les ventes en solde de ') }} {{$boutique->nom}} {{$boutique->localisation}}</h3>
                            </div>
					...
					<table class="table table-bordered bootstrap-datatable datatable bg-white" style="width:100%;" id="datatable-buttons">
					  ...
					  <tr>
						...
						<tr>
							<td>{{ ++$i }}</td>
							<td><a title="imprimer" href="{{route('print.facture',$sortie->facture->id)}}">{{ $sortie->facture->nom }}</a></td>
