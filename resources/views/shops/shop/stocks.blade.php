...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{$boutique->nom}} {{$boutique->localisation}} Stocks. </title>
        <!-- Favicon -->
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel">{{$boutique->nom}} {{$boutique->localisation}} Stocks.</h5>
                ...
                <div class="table-responsive card shadow">
					...
					<table class="table table-bordered bootstrap-datatable datatable bg-white" id="datatable-buttons"style="width:100%;">
					  ...
					  <tr>
						 ...
						 <th>Stocks réel</th>
						 @can('boutique-comptabilite')<th>Prix d'achat</th>
						 <th>Prix de vente</th>
						 <th>Vendus</th>
						 <th>Bénéfice</th>
						 <th>S.I * P.A</th>
