@extends('layouts.app', ['title' => __('Boutique Management')])

@section('content')
    @include('users.partials.header', ['title' => __('Ajouter une boutique')])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Gestion des Boutiques') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
							...
							@endif
							<form method="post" action="{{ route('shops.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
							<div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('telephone_1') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="telephone_1" id="input-telephone_1" class="form-control form-control-alternative{{ $errors->has('telephone_1') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le numero de telephone 1') }}" value="{{ old('telephone_1') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('telephone_2') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="telephone_2" id="input-telephone_2" class="form-control form-control-alternative{{ $errors->has('telephone_2') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le numero de telephone 2') }}" value="{{ old('telephone_2') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer l\'email') }}" value="{{ old('email') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('logo') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="file" name="logo" id="input-logo" class="form-control form-control-alternative{{ $errors->has('logo') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le logo') }}" value="{{ old('logo') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('numero_rc') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="numero_rc" id="input-numero_rc" class="form-control form-control-alternative{{ $errors->has('numero_rc') ? ' is-invalid' : '' }}" placeholder="{{ __('Entrer le numero du registre de commerce') }}" value="{{ old('numero_rc') }}" autofocus>
