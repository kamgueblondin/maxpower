...
@section('content')
    @include('users.partials.header', ['title' => __('Editer l\'Utilisateur')])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Gestion de utilisateur') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('user.index') }}" class="btn btn-sm btn-primary">{{ __('Retours à la liste') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									<div class="form-group">
										...
										<div class="custom-control custom-checkbox mb-3">
										  <input class="custom-control-input" name="roles[]" @foreach($userRole as $va) @if($v==$va) checked @endif @endforeach value="{{$v}}" id="customCheck1{{$v}}" type="checkbox">
