...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('shops/{id}/inventaires/avant', [BoutiqueController::class, 'avantInventaireUserShops'])->name('avant.inventaire.shops');
    Route::get('shops/{id}/inventaires/apres', [BoutiqueController::class, 'apresInventaireUserShops'])->name('apres.inventaire.shops');
    Route::get('shops/{id}/inventaires/view', [BoutiqueController::class, 'inventaireViewShops'])->name('view.inventaire.shops');
    ...
    Route::get('magasin/{magasinId}/evolution/{produtuitId}', [MagasinController::class, 'stocksMagasinEvolution'])->name('shops.show.evolution');
    ...
    Route::get('magasins/{id}/inventaires/avant', [MagasinController::class, 'avantInventaireUserMagasin'])->name('avant.inventaire.magasins');
    Route::get('magasins/{id}/inventaires/apres', [MagasinController::class, 'apresInventaireUserMagasin'])->name('apres.inventaire.magasins');
    Route::get('magasins/{id}/view/inventaires/', [MagasinController::class, 'inventaireViewUserMagasin'])->name('view.inventaire.magasins');
